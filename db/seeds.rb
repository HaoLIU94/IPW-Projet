...
Exam.create(name:"IPA",date:"15/03/2017",user_id:3,prof:"M.Genaud")
Exam.create(name:"MST",date:"23/05/2017",user_id:18,prof:"M.Perinel")
Exam.create(name:"EMI",date:"25/04/2017",user_id:19,prof:"M.Zervos")


Score.create(user_id:8,exam:"IPA",result:"18",prof:"M.Genaud")
Score.create(user_id:9,exam:"IPA",result:"16",prof:"M.Genaud")
Score.create(user_id:10,exam:"IPA",result:"12",prof:"M.Genaud")
Score.create(user_id:11,exam:"IPA",result:"10",prof:"M.Genaud")
Score.create(user_id:12,exam:"IPA",result:"15",prof:"M.Genaud")
Score.create(user_id:13,exam:"IPA",result:"10",prof:"M.Genaud")
Score.create(user_id:14,exam:"IPA",result:"11",prof:"M.Genaud")
Score.create(user_id:15,exam:"IPA",result:"14",prof:"M.Genaud")
Score.create(user_id:16,exam:"IPA",result:"17",prof:"M.Genaud")
Score.create(user_id:17,exam:"IPA",result:"13",prof:"M.Genaud")

Score.create(user_id:8,exam:"MST",result:"12",prof:"M.Perinel")
Score.create(user_id:9,exam:"MST",result:"15",prof:"M.Perinel")
Score.create(user_id:10,exam:"MST",result:"18",prof:"M.Perinel")
Score.create(user_id:11,exam:"MST",result:"16",prof:"M.Perinel")
Score.create(user_id:12,exam:"MST",result:"13",prof:"M.Perinel")
Score.create(user_id:13,exam:"MST",result:"10",prof:"M.Perinel")
Score.create(user_id:14,exam:"MST",result:"16",prof:"M.Perinel")
Score.create(user_id:15,exam:"MST",result:"11",prof:"M.Perinel")
Score.create(user_id:16,exam:"MST",result:"10",prof:"M.Perinel")
Score.create(user_id:17,exam:"MST",result:"15",prof:"M.Perinel")

Score.create(user_id:8,exam:"EMI",result:"17",prof:"M.Zervos")
Score.create(user_id:9,exam:"EMI",result:"12",prof:"M.Zervos")
Score.create(user_id:10,exam:"EMI",result:"13",prof:"M.Zervos")
Score.create(user_id:11,exam:"EMI",result:"16",prof:"M.Zervos")
Score.create(user_id:12,exam:"EMI",result:"10",prof:"M.Zervos")
Score.create(user_id:13,exam:"EMI",result:"15",prof:"M.Zervos")
Score.create(user_id:14,exam:"EMI",result:"17",prof:"M.Zervos")
Score.create(user_id:15,exam:"EMI",result:"15",prof:"M.Zervos")
Score.create(user_id:16,exam:"EMI",result:"14",prof:"M.Zervos")
Score.create(user_id:17,exam:"EMI",result:"11",prof:"M.Zervos")
