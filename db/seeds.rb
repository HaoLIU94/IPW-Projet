...
Exam.create(subjects_id:1,date:"15/03/2017",user_id:3,prof:"M.Genaud")
Exam.create(subjects_id:2,date:"23/05/2017",user_id:18,prof:"M.Perinel")
Exam.create(subjects_id:3,date:"25/04/2017",user_id:19,prof:"M.Zervos")


Score.create(user_id:8,exams_id:1,result:"18",prof:"M.Genaud")
Score.create(user_id:9,exams_id:1,result:"16",prof:"M.Genaud")
Score.create(user_id:10,exams_id:1,result:"12",prof:"M.Genaud")
Score.create(user_id:11,exams_id:1,result:"10",prof:"M.Genaud")
Score.create(user_id:12,exams_id:1,result:"15",prof:"M.Genaud")
Score.create(user_id:13,exams_id:1,result:"10",prof:"M.Genaud")
Score.create(user_id:14,exams_id:1,result:"11",prof:"M.Genaud")
Score.create(user_id:15,exams_id:1,result:"14",prof:"M.Genaud")
Score.create(user_id:16,exams_id:1,result:"17",prof:"M.Genaud")
Score.create(user_id:17,exams_id:1,result:"13",prof:"M.Genaud")

Score.create(user_id:8,exams_id:2,result:"12",prof:"M.Perinel")
Score.create(user_id:9,exams_id:2,result:"15",prof:"M.Perinel")
Score.create(user_id:10,exams_id:2,result:"18",prof:"M.Perinel")
Score.create(user_id:11,exams_id:2,result:"16",prof:"M.Perinel")
Score.create(user_id:12,exams_id:2,result:"13",prof:"M.Perinel")
Score.create(user_id:13,exams_id:2,result:"10",prof:"M.Perinel")
Score.create(user_id:14,exams_id:2,result:"16",prof:"M.Perinel")
Score.create(user_id:15,exams_id:2,result:"11",prof:"M.Perinel")
Score.create(user_id:16,exams_id:2,result:"10",prof:"M.Perinel")
Score.create(user_id:17,exams_id:2,result:"15",prof:"M.Perinel")

Score.create(user_id:8,exams_id:3,result:"17",prof:"M.Zervos")
Score.create(user_id:9,exams_id:3,result:"12",prof:"M.Zervos")
Score.create(user_id:10,exams_id:3,result:"13",prof:"M.Zervos")
Score.create(user_id:11,exams_id:3,result:"16",prof:"M.Zervos")
Score.create(user_id:12,exams_id:3,result:"10",prof:"M.Zervos")
Score.create(user_id:13,exams_id:3,result:"15",prof:"M.Zervos")
Score.create(user_id:14,exams_id:3,result:"17",prof:"M.Zervos")
Score.create(user_id:15,exams_id:3,result:"15",prof:"M.Zervos")
Score.create(user_id:16,exams_id:3,result:"14",prof:"M.Zervos")
Score.create(user_id:17,exams_id:3,result:"11",prof:"M.Zervos")
